...
<div class="hero-section">
  <div class="hero-content">
    <h1 class="hero-title">Muhammad Bilal</h1>
    <p class="hero-subtitle">AI Engineer | NLP | Computer Vision | Knowledge Graphs</p>
    <p class="hero-description">
      Passionate AI Engineer with expertise in developing intelligent systems for warehouse automation, 
      trade-based money laundering detection, and 3D motion analysis. Currently building AI agents that 
      bridge natural language and complex enterprise systems.
    </p>
    <div class="hero-links">
      <a href="mailto:bilal001.w@gmail.com" class="btn btn-primary">Contact Me</a>
      <a href="https://github.com/Bambokyo" class="btn btn-secondary" target="_blank">GitHub</a>
      <a href="https://linkedin.com/in/mbilal-1608-pk/" class="btn btn-secondary" target="_blank">LinkedIn</a>
    </div>
  </div>
</div>
